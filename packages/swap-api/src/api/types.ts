export const TOKEN_FEE_STRUCT_TYPE =
  "(address token, uint256 amount, address recipient)[]";

export const TRANSFORM_ERC20_FEATURE_ABI = [
  {
    anonymous: false,
    inputs: [
      {
  ...
  {
    inputs: [
      { internalType: "address", name: "transformerDeployer", type: "address" },
    ],
    name: "migrate",
...
export type Erc20Transform = { deploymentNonce: number; data: `0x${string}` };
export type TransformERC20Args = [
  `0x${string}`,
  `0x${string}`,
  bigint,
  bigint,
