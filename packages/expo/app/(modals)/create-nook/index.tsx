...
import { Channel, Panel } from '@/types'
...
export default function CreateNookScreen() {
  const headerHeight = useHeaderHeight()
  const { name, setName, panels, setPanels, create, isLoading } = useCreateNook()
